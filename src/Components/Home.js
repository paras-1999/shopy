                ...
                <Row>
                    <Col md={11}>
                        <Form.Floating className="mb-3">
                            <Form.Control type="text" placeholder="xyz" ref={search} />
                            <label>search</label>
                        </Form.Floating>
                    </Col>
                    <Button as={Col} variant="info" onClick={() => display()} style={{ height: "58px" }}>
                        <svg style={{ margin: "12px auto" }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-search" viewBox="0 0 16 16">
                        ...
                        if (cat == val.category) {
                            return (<Col md={4} xs={6} key={val.pname}>
                                <Card className="bg1" style={{ height: "320px" }}>
                                    <a className="outer">
                                        <span className="inner" style={{ backgroundImage: `url(${val.img1}),url(${val.img2} )` }}></span>
                                    </a>
                                    <Card.Body>
                        ...
                        if (cat == 'all') {
                            return (<Col md={4} xs={6} key={val.pname}>
                                <Card className={i % 2 ? "bg1" : "bg2"} style={{ height: "320px" }}>
                                    <a className="outer"> <span className="inner" style={{ backgroundImage: `url(${val.img1}),url(${val.img2} )` }}> </span>
                                    </a>
                                    <Card.Body>
...
// <Carousel>
// <Carousel.Item interval={1000}>
// <img className="d-block w-80 mx-auto" src={`${val.img1}`} height="250px"/>
// </Carousel.Item>
// <Carousel.Item interval={1000}>
// <img className="d-block w-80 mx-auto" src={`${val.img1}`} height="250px"/>
// </Carousel.Item>
